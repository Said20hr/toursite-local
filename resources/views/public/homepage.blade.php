<x-guest-layout>
    ...
    <section class="py-6 xl:py-20">
        <div class="container">
            <div class="border p-2 rounded-lg xl:border-0 xl:grid grid-cols-2 items-center gap-x-16 gap-y-12 xl:gap-y-24 mb-16 text-center xl:text-left">
        ...
        <div class="xl:container px-6 mx-auto text-center">
            ...
            <div class="mx-auto mt-12">
                    ...
                    <ul class="uk-slider-items uk-child-width-1-1 uk-child-width-1-1@m uk-child-width-1-3@l uk-child-width-1-1@s uk-grid">
                        <li class="h-full my-12">
                            <div class="p-8 bg-white rounded-2xl shadow-lg text-center h-full">
                                <img src="{{asset('images/testi.jpg')}}" alt="Profile" class="-mt-20 w-20 rounded-full">
                                <div class="text-center text-black my-4 font-semibold text-lg">Christine Beadle</div>
                ...
                <div class="mx-auto flex justify-center mt-12">
                    <a href="" target="_blank" class="rounded-full hover:bg-opacity-80 transition-color duration-100 px-12 py-4 text-white bg-secondary border border-elementary text-xl">
